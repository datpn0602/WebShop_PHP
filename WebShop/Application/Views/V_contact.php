	...
	<div class="row">
        ...
        <fieldset>
          <div class="control-group">
              ...
              <input type="text" class="form-control" placeholder="name" class="input-xlarge"/>
           
          </div>
          <br>
		   <div class="control-group">
           
              <input type="text" class="form-control" placeholder="email" class="input-xlarge"/>
           
          </div>
          <br>
		   <div class="control-group">
           
              <input type="text" class="form-control" placeholder="subject" class="input-xlarge"/>
          
          </div>
          <br>
          <div class="control-group">
              <textarea rows="3" id="textarea" class="form-control" class="input-xlarge"></textarea>
