   ...
   <form class="form-horizontal" method="post">
    <div class="form-group">
      ...
      <div class="col-sm-10" style="width:500px;">          
        <input type="text" class="form-control" id="ten_sp" placeholder="Tên sản phẩm" name="ten_sp" value="<?=$SanPham->ten_sp?>">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10" style="width:500px;">          
        <input type="number" class="form-control" id="so_luong" placeholder="Số lượng" name="so_luong" value="<?=$SanPham->so_luong?>">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2">Giá:</label>
      <div class="col-sm-10" style="width:500px;">          
        <input type="number" class="form-control" id="don_gia" placeholder="Giá" name="don_gia" value="<?=$SanPham->don_gia?>">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2">Số lượng bán:</label>
      <div class="col-sm-10" style="width:500px;">          
        <input type="text" class="form-control" id="so_luong_ban" placeholder="Số lượng bán" name="so_luong_ban" value="<?=$SanPham->so_luong_ban?>">
      </div>
    </div>
    <div class="form-group">
